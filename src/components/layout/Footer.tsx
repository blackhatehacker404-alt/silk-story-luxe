    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-heading mb-2">Kalai Fashions</h3>
            <p className="text-xs tracking-[0.3em] uppercase mb-4 opacity-60 font-body">Elampillai</p>
            <p className="text-sm leading-relaxed opacity-60 font-body">
              Handcrafted silk sarees from the weaving town of Elampillai,
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm opacity-60 font-body">
              <p>Elampillai, Salem District</p>
              <p>Tamil Nadu, India — 637502</p>
              <p>+91 98765 43210</p>
              <p>info@kalaifashions.com</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-background/20 text-center">
          <p className="text-xs tracking-[0.15em] opacity-40 font-body">
            © {new Date().getFullYear()} Kalai Fashions. All rights reserved. Handcrafted in Elampillai.
          </p>
        </div>
      </div>
    </footer>
